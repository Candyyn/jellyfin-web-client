                    ...
                    <Sheet.Content className="!rounded-t-xl">
                        <Sheet.Scroller className="rounded-t-xl scrollbar-hide">
                            <div>
                                ...
                                <div
                                    className="relative w-full aspect-[16/8] bg-gray-800 rounded-t-xl overflow-hidden animate-pulse">
                                    ...
                                    <>
                                        {isSeries && (
                                            <div className="mt-8">
                                                ...
                                                {jellyserr && (
                                                    <span className="text-gray-400">Missing episodes or season? Request more <a
                                                        className="text-white" href={jellyserr}>here</a>!</span>
                                                )
                                                }
                                            </div>
                                        )}
                                ...
                                {(isSeries || isEpisode) &&
                                    (item.SeriesId || item.SeriesName) && (
                                        <div>
                                            ...
                                            <div
                                                className=" flex flex-col md:flex-row gap-6 items-start bg-[#262729] rounded-lg">
                                                {/* Series Primary Image */}
                                                {seriesDetails?.Id &&
                                                    seriesDetails?.ImageTags?.Primary && (
                                                        <img
                                                            src={
                                                                api.getImageUrlProps({
